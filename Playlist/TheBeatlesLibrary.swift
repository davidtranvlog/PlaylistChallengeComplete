...
//  Playlist
//
//  Created by Thao Phung on 5/7/15.
...
struct TheBeatlesLibrary
{
    ...
    let album: [String: AnyObject] = [
        ...
        "coverImageName" : "A Hard Dayy's Night",
        "song" : ["A Hard Day's Night", "I Should Have Known Better", "If I Fell", "And I Love Her", "Tell Me Why", "Can't Buy Me Love",]]
